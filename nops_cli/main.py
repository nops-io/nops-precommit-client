...
def main():
    ...
    parser.add_argument('--json_out_file', required=False, help="File to add project cost outputs"
                                                                " in JSON format. This file can be "
                                                                "use to compute the comparative "
                                                                "cloud cost impact in later run")
